...
class Model: 
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			wordChars = open(os.path.join(os.path.abspath(os.path.dirname(__file__)),'../model/wordCharList.txt')).read().splitlines()[0]
			corpus = open(os.path.join(os.path.abspath(os.path.dirname(__file__)),'../data/corpus.txt')).read()
	...
	def setupTF(self):
		...
		modelDir = os.path.join(os.path.abspath(os.path.dirname(__file__)),'../model/')
	...
	def dumpNNOutput(self, rnnOutput):
		...
		dumpDir = os.path.join(os.path.abspath(os.path.dirname(__file__)),'../dump/')
	...
	def save(self):
		"save model to file"
		self.snapID += 1
		self.saver.save(self.sess, os.path.join(os.path.abspath(os.path.dirname(__file__)),'../model/snapshot'), global_step=self.snapID)
